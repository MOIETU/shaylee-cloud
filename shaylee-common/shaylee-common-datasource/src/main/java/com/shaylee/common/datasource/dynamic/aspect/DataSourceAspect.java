package com.shaylee.common.datasource.dynamic.aspect;

import com.shaylee.common.datasource.dynamic.annotation.DataSource;
...
public class DataSourceAspect {
    ...
    @Pointcut("@annotation(com.shaylee.common.datasource.dynamic.annotation.DataSource) " +
            "|| @within(com.shaylee.common.datasource.dynamic.annotation.DataSource)")
